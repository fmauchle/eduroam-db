<ul class="menu">
	<li><?php echo getLink("Realms", "realms/") ?></li>
	<li><?php echo getLink("Institutions", "institutions/") ?></li>
	...
	<li><?php echo getLink("Monitored Server Logs", "mon_ser_logs/") ?></li>
	<li><?php echo getLink("Monitored Realm Logs", "mon_realm_logs/") ?></li>
